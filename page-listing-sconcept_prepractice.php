<?php
/**Template Name: Самооценка студентов их готовности к практике*/
                ...
                if ( $wp_query->have_posts() ) {
                    while ( $wp_query->have_posts() )
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php if(empty($sconcept_prepractice)){$link_post = wp_insert_post($new_post);update_post_meta($students, 'sconcept_prepractice', $link_post); update_post_meta($link_post, 'sconcept_prepractice_student', $students); the_permalink($link_post);}else{the_permalink($sconcept_prepractice);}?>">
