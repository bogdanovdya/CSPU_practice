<?php
/**
 * The Template for displaying sconcept_prepractice single posts
 *
 * @package WordPress
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				$student = get_post_meta($sconcept_prepractice, 'sconcept_prepractice_student', true);
				$sconcept_prepractice_itog = (0.1*(get_post_meta( $sconcept_prepractice, 'OPK-2_1', true ) + get_post_meta( $sconcept_prepractice, 'OPK-2_2', true ) + get_post_meta( $sconcept_prepractice, 'OPK-2_3', true ) + get_post_meta( $sconcept_prepractice, 'OPK-2_4', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_1', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_2', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_3', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_4', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_5', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_6', true ) + get_post_meta( $sconcept_prepractice, 'PK-2_7', true ) + get_post_meta( $sconcept_prepractice, 'PK-3_1', true ) + get_post_meta( $sconcept_prepractice, 'PK-3_2', true ) + get_post_meta( $sconcept_prepractice, 'PK-3_3', true ) + get_post_meta( $sconcept_prepractice, 'PK-4_2', true ) + get_post_meta( $sconcept_prepractice, 'PK-4_2', true ) + get_post_meta( $sconcept_prepractice, 'PK-4_3', true ) + get_post_meta( $sconcept_prepractice, 'PK-4_4', true )))/18;
				...
				<div class="entry-content">
                    <table>
						...
						<tr>
							...
							<td><?php echo get_post_meta( $sconcept_prepractice, 'OPK-2_4', true ); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_1', true ); ?></td>
						</tr>
						<tr>
							<td>Грамотно выстраивать структуру урока</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_2', true ); ?></td>
						</tr>
						<tr>
							<td>Давать грамотные установки для работы с материалами урока</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_3', true ); ?></td>
						</tr>
						<tr>
							<td>Планировать и применять технологии, целесообразные для данного урока</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_4', true ); ?></td>
						</tr>
						<tr>
							<td>Оценивать работу учащихся в процессе использования современных методов и технологий</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_5', true ); ?></td>
						</tr>
						<tr>
							<td>Оформлять конспект и технологическую карту урока</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_6', true ); ?></td>
						</tr>
						<tr>
							<td>Анализировать собственную деятельность на уроке</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-2_7', true ); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-3_1', true ); ?></td>
						</tr>
						<tr>
							<td>Уметь планировать содержание программы воспитания и духовно-нравственного развития</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-3_2', true ); ?></td>
						</tr>
						<tr>
							<td>Владеть методологией и технологией развития личности</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-3_3', true ); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-4_1', true ); ?></td>
						</tr>
						<tr>
							<td>Владеть приемами организации деятельности обучающихся на уроке</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-4_2', true ); ?></td>
						</tr>
						<tr>
							...
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-4_3', true ); ?></td>
						</tr>
						<tr>
							<td>Владеть приемами организационно-управленческой деятельности учителя обеспечения учебно-воспитательного процесса</td>
							<td><?php echo get_post_meta( $sconcept_prepractice, 'PK-4_4', true ); ?></td>
						</tr>
